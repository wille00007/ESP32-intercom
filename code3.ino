 ...
 * VERSION: 3.0.0 (Analog Audio out via Internal DAC for PAM8403)
...
// NOTE: Microphone pins moved to 32 & 33 to free up Pin 25 for Internal DAC
#define I2S_BCK_IO        32  // Moved from 26
#define I2S_WS_IO         33  // Moved from 25
#define I2S_DI_IO         35  // Input from Microphone (INMP441)
// I2S_DO_IO (Pin 22) is removed because audio now goes straight out of Pin 25 internally!
...
void a2dp_sink_data_cb(const uint8_t *data, uint32_t len) {
    ...
    // FAST INTEGER MATH FOR VOLUME CONTROL
    ...
    size_t bytes_written;
    // The Internal DAC automatically converts the 16-bit PCM to analog out on Pin 25
...
void setup() {
    ...
    // 1. Setup I2S Audio Hardware (WITH BUILT-IN DAC ENABLED)
    i2s_config_t i2s_config = {
        .mode = (i2s_mode_t)(I2S_MODE_MASTER | I2S_MODE_TX | I2S_MODE_RX | I2S_MODE_DAC_BUILT_IN),
        .sample_rate = 44100,
        .bits_per_sample = I2S_BITS_PER_SAMPLE_16BIT,
        .channel_format = I2S_CHANNEL_FMT_RIGHT_LEFT,
        .communication_format = I2S_COMM_FORMAT_STAND_MSB, // Standard format for built-in DAC
    ...
    // Enable Internal DAC on Pin 25 (Right Channel)
    i2s_set_dac_mode(I2S_DAC_CHANNEL_RIGHT_EN);

    // Re-map the microphone pins so they don't block the DAC
    i2s_pin_config_t pin_config = {
        .bck_io_num = I2S_BCK_IO,
        .ws_io_num = I2S_WS_IO,
        .data_out_num = I2S_PIN_NO_CHANGE, // Output is handled by DAC mode
    ...
    // 3. Set Device Name and Identity
